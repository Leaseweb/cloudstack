...
public interface VirtualNetworkApplianceManager extends Manager, VirtualNetworkApplianceService {
    ...
    ConfigKey<String> NetworkVirtualRouterServiceOffering = new ConfigKey<>(String.class, NetworkVirtualRouterServiceOfferingCK, "Advanced", "",
    ...
    // LB service offering
    ConfigKey<String> HaProxyStatsUri = new ConfigKey<>(String.class, "haproxy.stats.uri", "Advanced", "/admin?stats",
            "Enable statistics and define the URI prefix to access them, default is '/admin?stats'", true, ConfigKey.Scope.Network, null);
    ConfigKey<String> HaProxyStatsAuth = new ConfigKey<>(String.class, "haproxy.stats.auth", "Advanced", "admin1:AdMiN123",
            "Enable statistics with authentication and grant access to an account, default is 'admin1:AdMiN123'", true, ConfigKey.Scope.Network, null);
    ConfigKey<String> HaProxySslConfiguration = new ConfigKey<>(String.class, "haproxy.ssl.configuration", "Advanced", "Inherited from global setting" ,
            "if 'none', no SSL configurations will be added, if 'old', refer to https://ssl-config.mozilla.org/#server=haproxy&server-version=1.8.17&config=old&openssl-version=1.0.2l if 'intermediate', refer to https://ssl-config.mozilla.org/#server=haproxy&server-version=1.8.17&config=intermediate&openssl-version=1.0.2l default value is 'none'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyStatsEnable = new ConfigKey<>(Boolean.class, "haproxy.stats.enable", "Advanced", "true",
            "Enable statistics reporting with default settings, default is 'true'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyGlobalStatsSocket = new ConfigKey<>(Boolean.class, "haproxy.global.stats.socket", "Advanced", "false",
            "Binds a UNIX socket to /var/run/haproxy.socket, default is 'false'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyHttp = new ConfigKey<>(Boolean.class, "haproxy.http", "Advanced", "true",
            "If LB is http, default is 'true' for port 80 and 'false' for others'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyHttp2 = new ConfigKey<>(Boolean.class, "haproxy.http2", "Advanced", "false",
            "Enable or disable HTTP2 support in HAproxy", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyHttpKeepalive = new ConfigKey<>(Boolean.class, "haproxy.http.keepalive", "Advanced", "false",
            "Enable or disable HTTP keep-alive, default is inherited from network offering", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyBackendHttps = new ConfigKey<>(Boolean.class, "haproxy.backend.https", "Advanced", "false",
            "If backend server is https. If yes, use 'check ssl verify none' instead of 'check'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Boolean> HaProxyTransparent = new ConfigKey<>(Boolean.class, "haproxy.transparent.mode", "Advanced", "false",
            "Enable or disable transparent mode, default is 'false'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyTimeoutConnect = new ConfigKey<>(Long.class, "haproxy.timeout.connect", "Advanced", "5000",
            "Set the maximum time to wait for a connection attempt to a server to succeed.", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyTimeoutServer = new ConfigKey<>(Long.class, "haproxy.timeout.server", "Advanced", "50000",
            "Set the maximum inactivity time on the server side.", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyTimeoutClient = new ConfigKey<>(Long.class, "haproxy.timeout.client", "Advanced", "50000",
            "Set the maximum inactivity time on the client side.", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyGlobalMaxConn = new ConfigKey<>(Long.class, "haproxy.global.maxconn", "Advanced", "4096",
            "Maximum per process number of concurrent connections, default is '4096'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyGlobalMaxPipes = new ConfigKey<>(Long.class, "haproxy.global.maxpipes", "Advanced", "1024",
            "Maximum number of per process pipes, default is 'maxconn/4'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyMaxConn = new ConfigKey<>(Long.class, "haproxy.maxconn", "Advanced", "2000",
            "Maximum per process number of concurrent connections per site/vm", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyFullConn = new ConfigKey<>(Long.class, "haproxy.fullconn", "Advanced", "200",
            "Specify at what backend load the servers will reach their maxconn, default is 'maxconn/10'", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyServerMaxConn = new ConfigKey<>(Long.class, "haproxy.server.maxconn", "Advanced", "0",
            "LB max connection per server, default is ''", true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyServerMinConn = new ConfigKey<>(Long.class, "haproxy.server.minconn", "Advanced", "0",
            "LB minimum connection per server, default is ''",  true, ConfigKey.Scope.Network, null);
    ConfigKey<Long> HaProxyServerMaxQueue = new ConfigKey<>(Long.class, "haproxy.server.maxqueue", "Advanced", "0",
            "Maximum number of connections which will wait in queue for this server, default is ''", true, ConfigKey.Scope.Network, null);
